...
type TransformFunc = (value: unknown, field: Field, record: Record<string, unknown>, index?: number) => unknown;
...
export function transformFieldValue(value: unknown, field: Field, record: Record<string, unknown>): unknown {
    if (!field.transform) {
        return value;
    }
